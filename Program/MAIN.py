...
input_data = IG.generate_aircraft(USE_PREGENERATED_DATA, sample_size=30, show_result=0)
...
# --> Fuel Constraint
num_F= 0
#Bay_Assignment, fuel_constraints, num_F = CONSTR_P.add_fuelling_constraint(input_data, Bay_Assignment, flight_vars, fb=1)
